...
class FallingDust:
    ...
    def update_and_draw(self, surface):
        self.y += self.speed_y
        # Rơi đung đưa nhẹ theo hình sin
...
while running:
    ...
    # 3. VẼ ĐỒ HỌA
    # Làm mờ khung hình cũ (Tạo đuôi sáng)
    screen.blit(fade_surf, (0, 0))

    # Cập nhật mưa rơi hậu cảnh
    for drop in rain:
        drop.update_and_draw(screen)

    # Tính toán nhịp đập trái tim
    ...
    sub_text = font_sub.render("by Nhat anh dev", True, (150, 150, 255))
